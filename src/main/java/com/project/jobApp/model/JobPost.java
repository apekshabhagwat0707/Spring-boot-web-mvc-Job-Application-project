...
//Data
//using @ data annotation dont need to create getter setter and toString method

//not need to create constructor bcz its resposible for default constructor and parameterized constructor it take all paramter
@NoArgsConstructor
